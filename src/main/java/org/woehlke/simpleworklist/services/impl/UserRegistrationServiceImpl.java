...
public class UserRegistrationServiceImpl implements
    ...
    @Override
    @Transactional(propagation = Propagation.REQUIRES_NEW, readOnly = false)
    public void passwordRecoverySentEmail(UserRegistration o) {
        o.setDoubleOptInStatus(UserRegistrationStatus.PASSWORD_RECOVERY_SENT_EMAIL);
        LOGGER.info("about to save: " + o.toString());
        userRegistrationRepository.saveAndFlush(o);
    }
    ...
    @Override
    @Transactional(propagation = Propagation.REQUIRES_NEW, readOnly = false)
    public void passwordRecoveryClickedInEmail(UserRegistration o) {
        o.setDoubleOptInStatus(UserRegistrationStatus.PASSWORD_RECOVERY_CLICKED_IN_MAIL);
        userRegistrationRepository.saveAndFlush(o);
    }
    ...
    public void passwordRecoverySendEmailTo(String email) {
        ...
        o.setDoubleOptInStatus(UserRegistrationStatus.PASSWORD_RECOVERY_SAVED_EMAIL);
        o.setEmail(email);
    ...
    @Override
    @Transactional(propagation = Propagation.REQUIRES_NEW, readOnly = false)
    public void passwordRecoveryDone(UserRegistration userRegistration) {
        userRegistration.setDoubleOptInStatus(UserRegistrationStatus.PASSWORD_RECOVERY_STORED_CHANGED);
