...
<!-- Document Window -->
<h1><span class="glyphicon glyphicon-road" aria-hidden="true"></span> <spring:message code="tasks.someday.h1" text="Someday" /></h1>
...
<c:if test="${! empty dataList}">
    <div>
        <table class="table table-striped table-hover">
            <tr>
                <th>&nbsp;</th>
                <th><spring:message code="tasks.someday.title" text="Title" /></th>
                <th><spring:message code="tasks.someday.text" text="Text" /></th>
                <th><spring:message code="tasks.someday.project" text="Project" /></th>
                <th>&nbsp;</th>
            </tr>
    ...
    <nav>
        ...
        <c:url var="lastUrl" value="/tasks/someday?page=${totalPages}" />
        <c:url var="prevUrl" value="/tasks/someday?page=${currentIndex - 1}" />
        <c:url var="nextUrl" value="/tasks/someday?page=${currentIndex + 1}" />
        <div>
            <ul class="pagination">
                <c:choose>
                ...
                <c:forEach var="i" begin="${beginIndex}" end="${endIndex}">
                    <c:url var="pageUrl" value="/tasks/someday?page=${i}" />
                    <c:choose>
...
<c:if test="${empty dataList}">
    <p><spring:message code="tasks.someday.noTasks" text="You have no Tasks for Someday" /></p>
</c:if>
