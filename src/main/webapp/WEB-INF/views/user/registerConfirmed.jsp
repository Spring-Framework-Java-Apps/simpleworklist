<%@ include file="/WEB-INF/views/includes/taglibs.jsp"%>
					...
					<form:form id="formId" commandName="userAccount" method="post" class="ym-form ym-columnar linearize-form">
                		...
                		<form:label path="userFullname" class="ym-label ym-full">Full Name  <sup class="ym-required">*</sup></form:label>
                		<form:input path="userFullname" class="ym-required"/><br/>
                		<form:errors path="userFullname" class="ym-message"/>
                		</div>
                		<div class="ym-fbox-text">
