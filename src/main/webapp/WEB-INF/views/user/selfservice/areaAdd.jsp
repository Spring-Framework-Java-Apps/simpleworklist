...
<h1><span class="glyphicon glyphicon-edit" aria-hidden="true"></span> <spring:message code="user.selfservice.areas.add.button" text="Add Area" /></h1>
...
<div>
    <form:form id="formId" commandName="newArea" method="post">
        <td>
        ...
        <td>
            <button id="createNewProject" type="submit" class="btn btn-default">
                ...
                <spring:message code="user.selfservice.areas.add.button" text="Add Area" />
            </button>
        </td>
        <td>&nbsp;</td>
    </form:form>
