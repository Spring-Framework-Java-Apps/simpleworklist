...
<head>
	...
	<link rel="stylesheet" href="<c:url value="/css/datepicker/default.css"/>">
	<link rel="stylesheet" href="<c:url value="/css/datepicker/default.date.css"/>">
...
<body>
    ...
    <!-- datepicker -->
	<script src="<c:url value="/js/datepicker/picker.js"/>"></script>
	<script src="<c:url value="/js/datepicker/picker.date.js"/>"></script>
	<script src="<c:url value="/js/datepicker/legacy.js"/>"></script>
	<!--
	<script src="<c:url value="/js/datepicker/de_DE.js"/>"></script>
	-->
	 <script>
