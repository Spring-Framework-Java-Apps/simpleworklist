...
CREATE DATABASE simpleworklist WITH OWNER simpleworklist ENCODING 'UTF8' LC_COLLATE 'de_DE.UTF-8' LC_CTYPE 'de_DE.UTF-8';
CREATE DATABASE simpleworklist_default WITH OWNER simpleworklist ENCODING 'UTF8' LC_COLLATE 'de_DE.UTF-8' LC_CTYPE 'de_DE.UTF-8';
CREATE DATABASE simpleworklist_branch_master WITH OWNER simpleworklist ENCODING 'UTF8' LC_COLLATE 'de_DE.UTF-8' LC_CTYPE 'de_DE.UTF-8';
CREATE DATABASE simpleworklist_testing WITH OWNER simpleworklist ENCODING 'UTF8' LC_COLLATE 'de_DE.UTF-8' LC_CTYPE 'de_DE.UTF-8';
CREATE DATABASE simpleworklist_qa WITH OWNER simpleworklist ENCODING 'UTF8' LC_COLLATE 'de_DE.UTF-8' LC_CTYPE 'de_DE.UTF-8';
CREATE DATABASE simpleworklist_heroku WITH OWNER simpleworklist ENCODING 'UTF8' LC_COLLATE 'de_DE.UTF-8' LC_CTYPE 'de_DE.UTF-8';
